...
public class ScreenShotUtil {
    ...
    public ScreenShotUtil(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mMediaProjection = getMediaProjectionManager().getMediaProjection(Activity.RESULT_OK, WcyApplication.intent);
...
//        if (WcyApplication.intent != null)
//            mMediaProjection = WcyApplication.mMediaProjectionManager.getMediaProjection(WcyApplication.result, WcyApplication.intent);
    }
