...
import wcy.godinsec.wcy_dandan.utils.ViewUtils;
...
public class HighLightGuideView extends View {
    ...
    public static final int VIEWSTYLE_NO = -1;
    //画笔类型，圆滑、默认
    ...
    private Bitmap inputPass, addEvent, unChain;// 指示箭头
    ...
    private int borderWitdh = 2;
    private int highLisghtPadding = 0;// 高亮控件padding

    private int mipTipsId;
    ...
    private void cal(Context context) {
        int[] screenSize = ViewUtils.getScreenSize((Activity) context);
    ...
    private void init(Context context) {
        ...
        mPaint.setMaskFilter(new BlurMaskFilter(0.1f, blurStyle));
        // 生成前景图Bitmap
        ...
        // 实例化箭头图片
        addEvent = BitmapFactory.decodeResource(getResources(), R.mipmap.add_event);
        inputPass = BitmapFactory.decodeResource(getResources(),R.mipmap.add_pass);
        unChain = BitmapFactory.decodeResource(getResources(), R.mipmap.add_unchain);
    }
...
//                switch (mipTipsId){
//                    case R.mipmap.add_event:
//                        canvas.drawBitmap(addEvent, left + vWidth / 2 - 50, bottom, null);
//                        break;
//                    case R.mipmap.add_pass:
//                        canvas.drawBitmap(inputPass, left, top, null);
//                        break;
//                    case R.mipmap.unchain:
//                        int width = unChain.getWidth();
//                        canvas.drawBitmap(unChain,  screenW - width - radius, bottom, null);
//                        break;
//
//                    default:
//                        break;
