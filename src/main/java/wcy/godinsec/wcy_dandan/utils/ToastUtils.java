...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(WcyApplication.getInstance().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(WcyApplication.getInstance().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(final CharSequence text, final int duration) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if (sToast == null) {
                    sToast = Toast.makeText(WcyApplication.getInstance(), text, duration);
                } else {
                    sToast.setText(text);
