...
/**
 * Auther：杨玉安 on 2017/11/23 13:55
...
public class DateUtils {
    ...
    public static void randomDateWhile(String beginDate, String endDate, int count) {
        List<Date> dataList = null;
        dataList = new ArrayList<>();
        int i = 0;
        while (i < count) {
            i++;
            LogUtils.e("=====" + randomDateString(beginDate, endDate));
            dataList.add(randomDate(beginDate, endDate));
        }
//        DataChangebean dataChangebean = new DataChangebean();
//        dataChangebean.setBrushCount(count);
//        dataChangebean.setBrushTiomeDates(dataList);
...
//        dataChangebean.setToday(dataFormatString());
     ...
     * 获取随机日期
     *
     * @param beginDate 起始日期，格式为：HH:mm:ss
     * @param endDate   结束日期，格式为：HH:mm:ss
     * @return
     */
    ...
    public static Date dateFormatDate(Date date) {
        ...
        dataFormat = format.format(date);
        Date parse = null;
        try {
            parse = format.parse(dataFormat);
    ...
    public static Date StringFoematDate(String beginDate) {
        try {
            SimpleDateFormat format = new SimpleDateFormat("HH:mm");
            Date start = format.parse(beginDate);
            return start;
    ...
    public static String randomDateString1(Date date) {
        try {
            SimpleDateFormat format = new SimpleDateFormat("HH:mm");
